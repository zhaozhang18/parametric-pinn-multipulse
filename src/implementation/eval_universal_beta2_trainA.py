...
def main() -> None:
    ...
    unseen_k, unseen_a = load_sparse8_csv(run_dir / "dataset" / "seen_sparse8_combinations.csv")
    ...
    for name, text in [("interpolation_D", args.interp_d), ("extrapolation_D", args.extra_d)]:
